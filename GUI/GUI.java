...
import simulation.VehicleParser;
...
public class GUI extends JFrame implements ActionListener{
	...
	public GUI() throws IntersectionCustomException {
		...
		for (String[] list : vehiclesListRowData)
			if (list[0] != null) intersection.addVehicle(VehicleParser.parseVehicleAttributes(list));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == AddVehicleButton)
		{
			...
			intersection.addVehicle(VehicleParser.parseVehicleAttributes(rowData));
		}
